        ...
        {sent ? (
          <div className="text-center py-6">
            ...
            <p className="text-gray-500 text-sm font-medium">
              ...
              Click the link to activate your account and sign in instantly.
            </p>
            <button onClick={() => setSent(false)} className="mt-6 text-sm text-brand-blue font-bold hover:underline">
          ...
          <>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[10px] text-gray-400 font-mono uppercase tracking-widest font-bold">or email magic link</span>
              <div className="h-[1px] bg-gray-200 flex-1"></div>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start pt-2">
                ...
                <label htmlFor="terms" className="ml-2 text-xs font-medium text-gray-500">
                  I agree to the{' '}
                  <Link href="/terms" className="text-brand-blue hover:underline font-bold">Terms</Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-brand-blue hover:underline font-bold">Privacy Policy</Link>.
                </label>
              </div>
            ...
            <p className="text-sm text-gray-500 font-medium text-center mt-6">
              ...
              <Link href="/login" className="text-brand-blue font-bold hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue rounded-sm">
                Sign in →
              </Link>
            </p>
