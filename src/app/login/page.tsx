        ...
        {sent ? (
          ...
          <>
            ...
            <p className="text-sm text-gray-500 font-medium text-center mt-8 mb-6">
              ...
              <Link href="/signup" className="text-brand-blue font-bold hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue rounded-sm">
                Start free →
              </Link>
            </p>
