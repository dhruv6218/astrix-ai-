        ...
        {sent ? (
          ...
          <>
            ...
            <p className="text-sm text-gray-500 font-medium text-center mt-8 mb-6">
              Don&apos;t have an account? <Link href="/signup" className="text-brand-blue font-bold hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue rounded-sm">Start free →</Link>
            </p>

            <div className="pt-6 border-t border-gray-100">
              <Link href="/signup?demo=true" className="w-full flex items-center justify-center gap-2 text-gray-700 bg-gray-50 hover:bg-gray-100 border border-gray-200 font-bold rounded-xl text-sm px-5 py-4 transition-all shadow-sm outline-none focus-visible:ring-4 focus-visible:ring-gray-200">
